...
public class Bouton extends JButton implements MouseListener {
    ...
    public Bouton(String str) {
        ...
        try {
            img = ImageIO.read(new File("images/fondBouton.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void mouseEntered(MouseEvent event) {
        ...
        try {
            img = ImageIO.read(new File("images/fondBoutonHover.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void mousePressed(MouseEvent event) {
        ...
        try {
            img = ImageIO.read(new File("images/fondBoutonClic.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
